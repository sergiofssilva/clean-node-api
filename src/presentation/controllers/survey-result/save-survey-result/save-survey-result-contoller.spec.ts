...
import type { LoadSurveyById, SurveyModel, SaveSurveyResultParams, HttpRequest, SaveSurveyResult, SurveyResultModel } from './save-survey-result-contoller-protocols'
